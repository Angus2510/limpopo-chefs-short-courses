...
export const COURSES: Course[] = [
  ...
  // ── September 2026 ─────────────────────────────────────────────────────────
  {
    ...
    includes: ["All ingredients", "Recipe booklet"],
    emoji: "🫐",
  ...
  {
    id: "cooking-club-sep",
    title: "3rd Wednesday Cooking Club: Chicken & Mushroom Ravioli",
    category: "Fundamentals",
    description:
  ...
  {
    id: "cooking-club-oct",
    title: "3rd Wednesday Cooking Club: Chicken Parmesan & Goddess Salad",
    category: "Fundamentals",
    description:
      "Join us every month for our Budget Cooking Club. Each month, you'll learn a new recipe, pick up new cooking skills, and enjoy a fun evening with fellow food lovers. This month's menu is Chicken Parmesan & Goddess Salad. No time to cook? No problem. Simply place your order, collect your meal, and enjoy a freshly prepared homemade dinner without the effort.",
    duration: "Evening",
    price: 200,
    bookingChoices: [
      {
